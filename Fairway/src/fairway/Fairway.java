                        ...
                        System.out.println("Nomor lowongan tidak valid.");
                            ...
                            while (true) {
                                ...
                                if (instansiChoice == 1) {
                                    ...
                                    System.out.println("Masukkan kategori lowongan: ");
                                    String kategori = scanner.nextLine();
                                    System.out.println("Masukkan lokasi kerja: ");
                                    String lokasiKerja = scanner.nextLine();
                                    System.out.println("Masukkan syaratPelamar: ");
                                    String syaratPelamar = scanner.nextLine();
                                    System.out.println("Masukkan waktu penerimaan: ");
                                    String hireDate = scanner.nextLine();
                                    System.out.println("Masukkan gaji: ");
                                    String gaji = scanner.nextLine();
                                    System.out.println("Masukkan maksimal waktu pelamaran: ");
                                    String expireDate = scanner.nextLine();
                                    System.out.println("Masukkan jumlah orang yang diterima: ");
